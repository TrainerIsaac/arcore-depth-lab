...
Shader "ARRealism/Relighting/Points Relighting"
{
    ...
    SubShader
    {
        Pass
        {
            ...
            //#include "Assets/CorruptLab/ARRealismDemos/Common/Shaders/TurboColormap.cginc"
    ...
    Subshader
    {
        Pass
        {
            ...
            CGPROGRAM
            #include "Assets/CorruptLab/ARRealismDemos/Common/Shaders/PreviewEmptyShader.cginc"
            ENDCG
        } // Pass
    } // Subshader for instant preview.
